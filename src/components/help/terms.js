...
const TermsAndConditions = ({ userProfile, agreementType }) => {
  ...
  const agreementContent = (
    `
    <div>
      <p>These terms and conditions (hereinafter referred to as “Terms”) govern the use of the services provided by Artisbay Inc. (hereinafter referred to as the “the Company”) through its online platform (hereinafter referred to as “the Service”). All registered users (hereinafter referred to as “Users”) agree to comply with the Terms outlined below. Specific terms regarding purchases can be found in the relevant sales conditions applicable to each transaction.</p>

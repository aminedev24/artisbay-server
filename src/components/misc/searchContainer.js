...
import "../../css/utilities/searchForm.css"; // Assuming you keep the CSS in a separate file
import VehicleSelector from "../vehicles/vehicleSelector"; // Import the new component
